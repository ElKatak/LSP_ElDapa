...
<aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
  ...
  <div class="sidebar-brand" style="background:#0F172A !important;">
    <a href="hal_admin.php" class="brand-link d-flex align-items-start gap-2" style="text-decoration:none;padding:12px 16px;">
      <div style="
      ...
      ">
        <img src="template/giwar-giwar.png" style="width:50px; object-fit:contain;">
      </div>
      <div>
        ...
        <div style="font-size:10px;color:#475569;font-weight:500;letter-spacing:0.3px;">
          <?php echo is_admin() ? 'Admin Panel' : 'Viewer Panel'; ?>
        </div>
      </div>
    </a>
  </div>
