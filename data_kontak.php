                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="card mb-10">
                        <div class="card-header">
                          <h3 class="card-title">Data Kontak</h3></div>
                            <div class="card-body">
                                ...
                                <tbody>
                                  ...
                                  <tr class="allign-middle">
                                    ...
                                    <td class="text-center">
                                      ...
                                      <a href="hapus_kontak.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-danger me-1" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
